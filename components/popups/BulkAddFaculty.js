...
import { bulk_add_faculty_to_class, get_all_students } from "../../store/class";
import { setPopup } from "../../store/settings";

const BulkAddFaculty = () => {
	...
	const onSubmit = (e) => {
		e.preventDefault();
		dispatch(bulk_add_faculty_to_class({ file: file, id: classId }));
        setFile(null)
