...
import { get_all_roles, update_role_by_id } from "../../store/roles";
...
const Roles = () => {
	...
	const [formData, setFormData] = useState({
		...
		university: selectedRole?.university,
	});
    ...
    useEffect(()=>{
        if(!selectedRole) setSelectedRole(rolesDataFromServer[0])
    }, [rolesDataFromServer, selectedRole])
    ...
    const handleSubmit = e => {
        e.preventDefault()
        dispatch(update_role_by_id({formData, id: selectedRole._id}))
    }
				...
				<div className="flex justify-between items-center mt-4 breadcrumps">
					...
					<div className="">
						<Button
							...
							onClick={() => dispatch(setPopup(CODES.ADD_ROLES))}
						>
							Add Roles
						</Button>
					</div>
					...
					<div className="roles_definition">
						<Paper className="roles_sticky">
							{rolesDataFromServer.map((e) => (
								<div
									className={
										selectedRole?.name === e.name
											? "role bg-[#efefef]"
											: "role"
									}
									key={e._id}
									onClick={() => setSelectedRole(e)}
								>
							...
							<form onSubmit={handleSubmit}>
								...
								<div className="single">
									...
									<div className="options">
										<div className="desc">
											<h5>Write class</h5>
											<p>
												Write and modify existing class
												data
											</p>
										</div>
										<Switch
								...
								<div className="single">
									...
									<div className="options">
										<div className="desc">
											<h5>Write events</h5>
											<p>
												Write and modify existing events
												data
											</p>
										</div>
										<Switch
								...
								<div className="single">
									...
									<div className="options">
										<div className="desc">
											...
											<p>
												Read and access utilities data
											</p>
										</div>
										<Switch
											checked={
												formData.utilities >= 0 &&
												formData.utilities !== 2
											}
											onChange={(e) =>
												setFormData({
													...formData,
													utilities: getSetterValue(
														e.target.checked,
														"read",
														formData.utilities
													),
								...
								<div className="single">
									<div className="flex justify-between items-center">
										<h6>Assignments</h6>
										<Switch
											checked={formData.assignments !== 2}
											onChange={(e) =>
												e.target.checked
													? setFormData({
															...formData,
									...
									<div className="options">
										<div className="desc">
											...
											<p>
												Read and access assignments data
											</p>
										</div>
										<Switch
											checked={
												formData.assignments >= 0 &&
												formData.assignments !== 2
											}
											onChange={(e) =>
												setFormData({
													...formData,
													assignments: getSetterValue(
														e.target.checked,
														"read",
								...
								<div className="single">
									...
									<div className="options">
										<div className="desc">
											<h5>Create roles</h5>
											<p>
												Create and assign roles to
												entities
											</p>
										</div>
										<Switch
											checked={formData.roles !== 2}
											onChange={(e) =>
												setFormData({
													...formData,
                                ...
                                <div className="flex justify-end m-4">
                                    <Button type="submit" className="table-buttons mt-4">Update Role</Button>
                                </div>
							</form>
						</Paper>
					</div>
